...
if ($db_found) {
    // Requête SQL pour récupérer tous les champs de tous les pays européens par ordre croissant de superficie
    $sql_select = "SELECT * FROM UnionEuropeenne ORDER BY Superficie ASC";
