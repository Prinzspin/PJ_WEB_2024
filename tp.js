$(document).ready(function(){ 
    ...
    var $controles = $('.controls');//on cible le bloc controle ou il y a les boutons 
    ...
    $controles.append('<div class="controls"> <span class="prev">Precedent</span> <span class="next">Suivant</span> </div>'); 
